...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/devalue/index.js';
import destr from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/vue/index.mjs';
import { basename } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/unstorage/drivers/fs.mjs';
import { collections } from 'file://D:/vue-proj/vue-nuxt-demo/.nuxt/nuxt-icon-server-bundle.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/vue-proj/vue-nuxt-demo/node_modules/@unhead/shared/dist/index.mjs';
...
const rootDir = "D:/vue-proj/vue-nuxt-demo";
...
const _Q0xtt8T87s = (function(nitro) {
...
const _RcTcAoBdUV = defineNitroPlugin((nitro) => {
...
const _zxvQJo = defineEventHandler((event) => {
});
...
const serverAssets = [{"baseName":"server","dir":"D:/vue-proj/vue-nuxt-demo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\vue-proj\\vue-nuxt-demo","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\vue-proj\\vue-nuxt-demo\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\vue-proj\\vue-nuxt-demo\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\vue-proj\\vue-nuxt-demo\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\vue-proj\\vue-nuxt-demo\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _HApftE = defineCachedEventHandler(async (event) => {
...
const _lazy_MyWJdp = () => Promise.resolve().then(function () { return test_get$1; });
const _lazy_Egb0eV = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _zxvQJo, lazy: false, middleware: true, method: undefined },
  { route: '/api/test', handler: _lazy_MyWJdp, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_Egb0eV, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _HApftE, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Egb0eV, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/vue-proj/vue-nuxt-demo/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/vue-proj/vue-nuxt-demo/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
