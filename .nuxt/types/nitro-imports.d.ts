declare global {
  ...
  const defineWrappedResponseHandler: typeof import('../../server/utils/handler')['defineWrappedResponseHandler']
...
export { defineWrappedResponseHandler } from '../../server/utils/handler';